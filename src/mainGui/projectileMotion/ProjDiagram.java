...
public class ProjDiagram extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g2d.drawLine((int) (d.getWidth() / 10), (int) (d.getHeight() * 0.8),
				(int) (d.getWidth() / 10 * 9), (int) (d.getHeight() * 0.8));
		...
		if (v[4].contents.equals("0")) {
			...
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10),
					(int) (d.getHeight() * 0.8), (int) (d.getWidth() / 10), y
							+ r, r / 2);
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10), y + r,
					(int) (d.getWidth() / 10), (int) (d.getHeight() * 0.8),
					r / 2);
			label = new String(v[4].contents.equals("?") ? v[4].name
					: v[4].contents);
			g2d.drawString(label + " m", (int) (d.getWidth() / 10) - r,
					(int) (1.5 * y));
		}
		int ry;
		int rx = v[10].contents.equals("0") ? (int) (d.getWidth() / 10)
				: (int) (d.getWidth() * 0.7);
		...
		if (!v[10].contents.equals("0")) {
			int t = ry;
			ry = (int) (d.getHeight() * 0.8 - r);
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10 + r),
					(int) (ry + 1.5 * r), rx, (int) (ry + 1.5 * r), r);
			MathUtil.drawArrow(g2d, rx, (int) (ry + 1.5 * r),
					(int) (d.getWidth() / 10 + r), (int) (ry + 1.5 * r), r);
			label = new String(v[10].contents.equals("?") ? v[10].label
					: v[10].contents);
		...
		int ctrlY = 0;
		int ctrlX = (int) (((d.getWidth() * 0.7 + r / 2) - (d.getWidth() / 10 + r / 2)) / 2 + (d
				.getWidth() / 10 + r / 2));
		// draw arrows
		if (v[9].getVal() > 0 || v[9].contents.equals("?")) {
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10 + r / 2), y,
					(int) (d.getWidth() / 10 + r / 2), y - 2 * r, r);
			ctrlY = (int) (y * 0.1 + r);
			g2d.drawArc(
					(int) (d.getWidth() / 10) - r,
					y - r,
			...
			label = new String(v[0].contents.equals("?") ? v[0].label
					: v[0].contents);
			g2d.drawString(label, (int) (d.getWidth() / 10 + 2.1 * r),
					(int) (y * 1.01));
			label = new String(v[9].contents.equals("?") ? v[9].label
					: v[9].contents);
			g2d.drawString(label + " m/s", (int) (d.getWidth() / 10 + r / 2),
					(int) (y * 0.94));

		} else if (v[9].getVal() < 0) {
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10 + r / 2), y,
					(int) (d.getWidth() / 10 + r / 2), y + 3 * r, r);
			ctrlY = (int) (y * 1.2 + r);
			ctrlX *= 1.6;
			g2d.drawArc(
					(int) (d.getWidth() / 10) - r,
		...
		if (!v[8].contents.equals("0")) {
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10 + r), y + r / 2,
					(int) (d.getWidth() / 10 + 3 * r), y + r / 2, r);
			label = new String(v[8].contents.equals("?") ? v[8].label
					: v[8].contents);
			g2d.drawString(label + " m/s", (int) (d.getWidth() / 10 + 2 * r),
					(int) (y + r));
		}
		if (!v[10].contents.equals("0")) {
			...
			QuadCurve2D.Double curve = new QuadCurve2D.Double(
					(int) (d.getWidth() / 10) + r / 2, y + r / 2, ctrlX, ctrlY,
					rx + r / 2, ry + r / 2);
			g2d.draw(curve);
			g2d.setStroke(norm);
		}
