...
public class Obj {
	 ...
	 * @param ox center of canvas (x axis)
	 * @param oy  center of canvas on y axis,
	 ...
	 * 
	 * @see <a href="https://en.wikipedia.org/wiki/Ray_casting">https://en.wikipedia.org/wiki/Ray_casting</a>
