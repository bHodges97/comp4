		...
		butDone.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				while(true){
					...
					Shape s = new Shape(new MyPoint[]{new MyPoint(0-cx,w-cy),new MyPoint(h-cx,w-cy),new MyPoint(h-cx,0-cy),new MyPoint(0-cx,0-cy)});
					returnObj = new Obj(0,new MyPoint(xval+cx,yval+cy),s,0,0);
					filled = true;
					close();
					return;
				}
