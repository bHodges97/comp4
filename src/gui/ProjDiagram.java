...
public class ProjDiagram extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if (v[4].contents.equals("0")) {
			...
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10), (int) (d.getHeight() * 0.8),
					(int) (d.getWidth() / 10 ), y + r, r);
			MathUtil.drawArrow(g2d,(int) (d.getWidth() / 10), y + r,(int) (d.getWidth() / 10), (int) (d.getHeight() * 0.8),
					r);
		...
		if(v[12].getVal() == 0 || v[12].contents.equals("?")){
			...
			//TODO:FInish
			MathUtil.drawArrow(g2d,rx+r/2,(int) (d.getHeight() * 0.8 - r),rx+r/2,ry,r);
		}
		...
		int ctrlY = 0;
		int ctrlX = (int) (((d.getWidth() * 0.7 + r / 2) - (d.getWidth() / 10 + r / 2))/2 + (d.getWidth() / 10 + r / 2));
		if (v[9].getVal() > 0 || v[9].contents.equals("?")) {
			MathUtil.drawArrow(g2d, (int) (d.getWidth() / 10 + r / 2), y, (int) (d.getWidth() / 10 + r / 2), y - 2 * r,
					r);
			ctrlY = (int) (y * 0.1 + r);
			g2d.drawArc((int) (d.getWidth() / 10) -r, y - r,3*r,3*r,0,(int) Math.toDegrees(Math.atan(d.getHeight()/d.getWidth())));
			...
			ctrlY = (int) (y * 1.2 + r);
			ctrlX*=1.6;
			g2d.drawArc((int) (d.getWidth() / 10) -r, y - r,3*r,3*r,0,(int)(Math.toDegrees(Math.atan((ctrlY-d.getHeight() * 0.8 - r)/ctrlX)))+10);
			label = new String(v[0].contents.equals("?")?v[0].label:v[0].contents);
		...
		if(v[3].getVal() < 0 || v[3].contents.equals("?")){
			...
			g2d.drawString(label+" m/s", (int)(rx +r/2+2), (int)(ry+2*r));
		}
